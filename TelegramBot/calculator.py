...
keyboard.row(telebot.types.InlineKeyboardButton('8', callback_data='8')),
keyboard.row(telebot.types.InlineKeyboardButton('9', callback_data='9')),
keyboard.row(telebot.types.InlineKeyboardButton('*', callback_data='*')),

keyboard.row(telebot.types.InlineKeyboardButton('4', callback_data='4')),
keyboard.row(telebot.types.InlineKeyboardButton('5', callback_data='5')),
